  ...
  render() {
    return (
      <div className="thumbnail event-card clearfix z-depth-1 negative-top ">
        ...
        <button className="btn btn-success pull-right round-me pull-right">More</button>
        <button className="btn btn-default pull-right round-me pull-right" style={{marginRight:7}}>RSVP</button>
        </div>
